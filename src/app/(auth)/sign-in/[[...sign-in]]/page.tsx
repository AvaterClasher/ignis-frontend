...
export default function SignInPage() {
  return (
    <div className="flex min-h-screen flex-col">
      {/* Header */}
      {/* <header className="flex h-16 items-center justify-center border-b bg-background px-4 sm:px-6">
        <h1 className="font-bold text-2xl">Ignis 🔥</h1>
      </header> */}
              ...
              <>
                <SignIn.Step name="start">
                  <Card className="w-full sm:w-96">
                    <CardHeader>
                      <CardTitle>Sign in to Ignis 🔥</CardTitle>
                      <CardDescription>
                            ...
                            <div className="flex justify-center text-center">
                              <Clerk.Input
                                ...
                                render={({ value, status }) => {
                                  return (
                                    <div
                                      className="relative flex h-9 w-9 items-center justify-center border-input border-y border-r text-sm shadow-sm transition-all first:rounded-l-md first:border-l last:rounded-r-md data-[status=cursor]:ring-1 data-[status=cursor]:ring-ring data-[status=selected]:ring-1 data-[status=selected]:ring-ring"
                                      data-status={status}
                                    >
                                      {value}
                                    </div>
